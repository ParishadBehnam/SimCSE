...
from sentence_encoder.models import HFInstructor
...
class InstructorForCL(HFInstructor):
    def __init__(
        self,
        model,
        tokenizer,
    ...
    def cl_forward(cls,
        ...
        token_type_ids = sentence_feature.get("token_type_ids")
        position_ids = sentence_feature.get("position_ids")
        ...
        # # Pooling
        # pooler_output = cls.pooler(attention_mask, outputs)
        output = output.view((batch_size, num_sent, output.size(-1))) # (bs, num_sent, hidden)
