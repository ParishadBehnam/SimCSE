...
class CLTrainer(Trainer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CLTrainer, self).__init__(args=args, **kwargs)
    ...
    def evaluate(
        ...
        metrics = {"eval_stsb_spearman": stsb_spearman, "eval_sickr_spearman": sickr_spearman, "eval_avg_sts": (stsb_spearman + sickr_spearman) / 2, "step": self.state.global_step} 
        if eval_senteval_transfer or self.args.eval_transfer:
            avg_transfer = 0
